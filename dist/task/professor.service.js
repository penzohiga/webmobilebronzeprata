...
const professor_repository_1 = require("./professor.repository");
...
let ProfessorService = (() => {
    let ProfessorService = class ProfessorService {
        ...
        async addProfessor(createProfessorDto) {
